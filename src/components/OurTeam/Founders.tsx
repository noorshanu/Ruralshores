          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {founders.map((founder, index) => (
              <div key={index} className="relative max-w-md mx-auto lg:mx-0">
                ...
                <div className="relative z-20 bg-white rounded-2xl p-6 shadow-lg mb-4">
                  <div className="flex flex-col items-center text-center">
                    {/* Profile Image */}
                    <div className="w-24 h-24 rounded-full border-2 border-gray-200 overflow-hidden bg-gray-200 mb-4">
